...
class York_Range_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'york-customize-range-control', get_theme_file_uri( '/assets/css/customize-range-control.css' ), false, '1.1.0', 'all' );
		wp_enqueue_script( 'york-customize-range-control', get_theme_file_uri( '/assets/js/customize-range-control.js' ), array( 'jquery' ), '1.1.0', true );
	}
